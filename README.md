...
src/
  ...
  │     │     ├── BoardList.jsx    # 게시글 목록 페이지
  │     │     └── BoardWrite.jsx   # 게시글 작성 페이지
  │     ├── plan/                      # 여행 플랜 관련 페이지 컴포넌트
  │     │     ├── EditPlan.jsx     # 플랜 수정 페이지 (기존 데이터를 편집 가능)
  │     │     ├── NewPlan.jsx      # 새 플랜 작성 페이지
  │     │     └── PlanComplete.jsx # 플랜 완료 페이지 (PDF 저장, 마이페이지 저장 기능 포함)
  │     └── Home.jsx                   # 홈 페이지
  ...
  │     ├── board.js                   # 게시판 관련 스타일
  │     ├── global.js                  # 전역 스타일
  │     ├── plan.js                    # 여행 플랜 관련 스타일
  │     └── survey.js                  # 사전 조사 페이지 스타일
  ├── App.js                           # 전체 앱의 진입점
